            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                >
                  ...
                  <option value="colleges_only">All Partner Institutions</option>
                  <option value="recruiters_only">All Corporate Recruiters</option>
                  <option value="all_users">Entire Platform (All Roles)</option>
                </select>
              </div>
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <option value="urgent">High Priority Banner</option>
          ...
          <div>
            ...
            <div className="space-y-3 pt-4 text-xs text-slate-600">
              <div className="p-3 bg-purple-50/50 border border-purple-100 rounded-xl">
                <p className="font-bold text-purple-900">Urgent Priority</p>
