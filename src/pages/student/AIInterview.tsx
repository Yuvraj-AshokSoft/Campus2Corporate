...
export default function AIInterview() {
  ...
  const voice = useVoiceInterview(submitAnswer);
  ...
  useEffect(() => { if (question?.question && !processing) voice.speak(question.question); }, [question?.question, processing, voice.speak]);
