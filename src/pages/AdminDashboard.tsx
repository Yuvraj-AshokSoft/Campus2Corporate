...
const integrations: Array<{ name: string; status: string; detail: string; icon: IconName; color: string }> = [
  { name: "ATS Sync", status: "Connected", detail: "Greenhouse · Lever · Workday", icon: "plug", color: "#7c3aed" },
...
const readinessSegments = [
  { label: "Profile verified", value: "92%", pct: 92, color: "#7c3aed" },
...
const opsMetrics = [
  { label: "Assessment completion", value: "86%", pct: 86, color: "#7c3aed" },
