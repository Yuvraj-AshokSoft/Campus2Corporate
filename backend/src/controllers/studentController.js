...
export const registerStudent = async (req, res) => {
  try {
    ...
    if (mongoose.connection.readyState !== 1) {
      ...
      return authPayload(mockStudent, "Student registered successfully (Offline Demo Mode)", 201, res);
    }
  ...
  try {
    ...
    if (mongoose.connection.readyState !== 1) {
      ...
      const mockStudent = {
        _id: mockId,
        id: mockId,
        name: normalizedEmail.split("@")[0] || "Student User",
        email: normalizedEmail,
        phone: "+91 9876543210",
      ...
      return authPayload(mockStudent, "Student logged in successfully (Offline Demo Mode)", 200, res);
    }
