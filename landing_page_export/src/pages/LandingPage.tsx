  ...
  return (
    <div className="min-h-screen bg-slate-50/30 text-slate-800 font-sans selection:bg-blue-100 selection:text-blue-800 overflow-x-hidden relative">
      ...
      <header className="relative z-50 border-b border-slate-200/50 bg-white/70 backdrop-blur-md sticky top-0 shadow-sm transition-all duration-300">
        ...
        {showMobileMenu && (
          <div className="lg:hidden border-b border-slate-200 bg-white/95 backdrop-blur-md px-6 py-5 shadow-xl animate-in slide-in-from-top-2 duration-200 space-y-4">
            <div className="flex flex-col space-y-3 text-sm font-semibold text-slate-700">
              <a 
                href="#problem" 
                onClick={() => setShowMobileMenu(false)}
                className="py-2 hover:text-[#5e17eb] transition-colors border-b border-slate-100"
              >
                Problem
              </a>
              <a 
              ...
              {/* Dashboards in Mobile Menu */}
              <div className="pt-2">
                <p className="text-[11px] font-extrabold uppercase text-slate-400 tracking-wider mb-2">Dashboards</p>
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <Link 
                    to="/student-dashboard" 
                    onClick={() => setShowMobileMenu(false)}
                    className="p-2.5 bg-slate-50 hover:bg-purple-50 text-slate-700 hover:text-[#5e17eb] font-bold rounded-xl border border-slate-200 text-center"
                  >
                    Student
                  </Link>
                  <Link 
              ...
              {isAuthenticated ? (
                <>
                  <button
                    ...
                    className="w-full py-2.5 text-center bg-[#5e17eb] text-white text-xs font-bold rounded-xl shadow-sm cursor-pointer"
                  >
                    Go to Dashboard
                  </button>
                  <button
                    ...
                    className="w-full py-2.5 text-center bg-rose-50 text-rose-600 border border-rose-200 text-xs font-bold rounded-xl cursor-pointer"
                  >
                    Sign Out
                  </button>
                </>
                ...
                <>
                  <button
                    ...
                    className="w-full py-2.5 text-center border border-slate-200 text-slate-700 text-xs font-bold rounded-xl bg-slate-50 cursor-pointer"
                  >
                    Login
                  </button>
                  <button
